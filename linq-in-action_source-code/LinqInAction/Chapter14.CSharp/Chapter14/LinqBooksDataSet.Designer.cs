...
namespace LinqInAction.Chapter14.LinqBooksDataSetTableAdapters {
...
SELECT ID, Title, Subject, Publisher, PubDate, Price, PageCount, Isbn, Summary, Notes FROM Book WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LinqInAction.Chapter14.Properties.Settings.Default.LinqBooksConnectionString;
        }
        ...
        public virtual int Update(
                    ...
                    string Original_Summary, 
                    string Original_Notes) {
            return this.Update(Original_ID, Title, Subject, Publisher, PubDate, Price, PageCount, Isbn, Summary, Notes, Original_ID, Original_Title, Original_Subject, Original_Publisher, Original_PubDate, Original_Price, Original_PageCount, Original_Isbn, Original_Summary, Original_Notes);
        }
    }
...
SELECT ID, Name, Logo, WebSite FROM Publisher WHERE (ID = @ID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, byte[] Logo, string WebSite, System.Guid Original_ID, string Original_Name, string Original_WebSite) {
            return this.Update(Original_ID, Name, Logo, WebSite, Original_ID, Original_Name, Original_WebSite);
        }
    }
